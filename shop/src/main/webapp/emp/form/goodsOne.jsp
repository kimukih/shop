...
<%
	...
	String goodsOneSql = "SELECT emp_id empId, goods_img goodsImg, goods_no goodsNo, goods_title goodsTitle, goods_content goodsContent, goods_price goodsPrice, goods_amount goodsAmount FROM goods WHERE goods_no = ?";
